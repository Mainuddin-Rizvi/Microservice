package com.mainuddin.CouponService.security.config;

import com.mainuddin.CouponService.security.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .mvcMatchers("/login","/","/logout","/showRegister","/registerUser").permitAll()
